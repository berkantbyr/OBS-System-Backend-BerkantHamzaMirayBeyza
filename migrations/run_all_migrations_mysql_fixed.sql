-- Run all migrations for MySQL (Fixed Version)
-- Execute this file after connecting to the database

USE campus_db;

-- 1. Add account lockout fields (already done, but safe to run)
ALTER TABLE users 
...
-- Note: Using same charset and collation as users table
